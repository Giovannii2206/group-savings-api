...
namespace GroupSavingsApi.Tests
{
    public class ApiControllersEdgeTests
    {
        ...
        public async Task MemberController_SoftDelete_HidesFromList()
        {
            ...
            var member = new Member { Id = Guid.NewGuid(), FirstName = "X", LastName = "Y", Phone = "1", Email = "e", AccountBalance = 10, IsDeleted = false };
            ...
            Assert.NotNull(list);
            Assert.DoesNotContain(list, m => m.Id == member.Id);
        }
